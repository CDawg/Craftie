...
Craftie.Logger.Title:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, "SLUG")
...
Craftie.Logger.Debug:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, "SLUG")
...
for k,v in ipairs(columns) do
  ...
  Craftie.Logger.Col[k].Text:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, "SLUG")
...
function Craftie:Log(type, log)
  ...
  for k,v in ipairs(columns) do
    ...
    Craftie.Logger.Row[id][k]:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, "SLUG")
    Craftie.Logger.Row[id][k]:SetPoint("TOPLEFT", v[3]-5, 0)
    Craftie.Logger.Row[id][k]:SetText(id)
    if (k == 1) then
      Craftie.Logger.Row[id][k]:SetFont(Craftie._G.Font.Style.Numeric, Craftie._G.Font.Size, "SLUG")
      Craftie.Logger.Row[id][k]:SetPoint("TOPLEFT", v[3]+5, 0)
    end
    if (k == 2) then
      Craftie.Logger.Row[id][k]:SetFont(Craftie._G.Font.Style.Numeric, Craftie._G.Font.Size-1, "SLUG")
...
Craftie.Logger.Output:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size+1, "OUTLINE")
