...
function Craftie:ScrollBarFrame(frame)
  ...
  ScrollBack:SetSize(26, frame:GetHeight()-44)
  ScrollBack:SetPoint("TOPLEFT", frame:GetWidth()-29, -23)
  ...
  ScrollTop:SetSize(26, 60)
  ScrollTop:SetPoint("TOPLEFT", frame:GetWidth()-29, -14)
  ScrollTop:SetTexture(Craftie._G.Path .. "Images/UI-Craftie-Scroll-Top.png", "REPEAT")
  --[==[
  ScrollBot = frame:CreateTexture(nil, "BORDER")
  ScrollBot:SetSize(26, 40)
  ScrollBot:SetPoint("TOPLEFT", frame:GetWidth()-29, ScrollBack:GetHeight()-60)
  ScrollBot:SetVertTile(true)
  ScrollBot:SetTexture(Craftie._G.Path .. "Images/UI-Craftie-Scroll-Bot.png", "REPEAT")
  ]==]--
end
