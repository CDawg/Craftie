...
function Craftie:ScrollBarFrame(frame)
  ...
  ScrollTop:SetTexture(Craftie._G.Path .. "Images/UI-Craftie-Scroll-End.png")
  ScrollBot = frame:CreateTexture(nil, "BORDER")
  ScrollBot:SetSize(26, 32)
  ScrollBot:SetPoint("TOPLEFT", frame:GetWidth()-41.5, -ScrollBack:GetHeight()+1.5)
  ScrollBot:SetTexture(Craftie._G.Path .. "Images/UI-Craftie-Scroll-End.png")
  ScrollBot:SetRotation(-math.pi)
end
