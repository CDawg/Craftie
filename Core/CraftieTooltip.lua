...
CraftieTooltipArtTL:SetWidth(20)
CraftieTooltipArtTL:SetHeight(20)
CraftieTooltipArtTL:SetPoint("TOPLEFT", -8, 5)
CraftieTooltipArtTL:SetTexture(Craftie._G.Path .. Craftie._G.Icon .. ".png")
