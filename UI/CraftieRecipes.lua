...
Craftie.Frame.ScrollRecipesParent.Back:SetAlpha(0.7)
...
Craftie.Frame.ScrollRecipesList:SetHeight(dimensions.H)
Craftie.Frame.ScrollRecipesList:SetPoint("CENTER", 2, -12)
...
Craftie.Frame.ScrollRecipesList.Child:SetPoint("TOPLEFT", Craftie.Frame.ScrollRecipesList, "TOPLEFT",         -2,-10)
...
Craftie.Frame.ScrollRecipesResultsBack:SetTexture(Craftie._G.Image.Scrollbar.Footer)
...
Craftie.Frame.ScrollRecipesLoading:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size+2, Craftie._G.Font.Flags)
...
Craftie.Frame.ScrollRecipesEmpty:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, Craftie._G.Font.Flags)
...
Craftie.Frame.DropdownRecipes.text:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, Craftie._G.Font.Flags)
...
Craftie.Frame.DropdownRecipes.Back:SetTexture(Craftie._G.Image.Scrollbar.Dropdown)
...
Craftie.Frame.Search.Recipes.Back:SetTexture(Craftie._G.Image.Scrollbar.Search)
...
Craftie.Frame.Button.SearchRecipesClearIcon:SetTexture(Craftie._G.Image.Button.Clear)
...
Craftie.Frame.ScrollRecipesListCount={}
...
for i=1, Craftie.MAX_RECIPES do
  ...
  Craftie.Frame.ScrollRecipesListBack[i]:SetTexture(Craftie._G.Image.Row[1])
  ...
  Craftie.Frame.ScrollRecipesListSelect[i]:SetTexture(Craftie._G.Image.Row.Select)
  ...
  Craftie.Frame.ScrollRecipesListCount[i] = Craftie.Frame.ScrollRecipesListRow[i]:CreateFontString(nil, "ARTWORK")
  Craftie.Frame.ScrollRecipesListCount[i]:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, Craftie._G.Font.Flags)
  Craftie.Frame.ScrollRecipesListCount[i]:SetPoint("TOPRIGHT", -16, -5)
  Craftie.Frame.ScrollRecipesListCount[i]:SetText(0)
  Craftie.Frame.ScrollRecipesListCount[i]:SetTextColor(1, 1, 1, 0.8)
  ...
  if (i % 2 == 0) then
    Craftie.Frame.ScrollRecipesListBack[i]:SetTexture(Craftie._G.Image.Row[2])
  end
  if (i % 4 == 0) then
    Craftie.Frame.ScrollRecipesListBack[i]:SetTexture(Craftie._G.Image.Row[3])
  end
end
