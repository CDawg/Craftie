...
Craftie.Frame.ScrollRecipes.ResultsFrame:SetWidth(Craftie.Frame.ScrollRecipes_Width-25)
Craftie.Frame.ScrollRecipes.ResultsFrame:SetHeight(25)
Craftie.Frame.ScrollRecipes.ResultsFrame:SetPoint("BOTTOMLEFT", 3, -3)
...
Craftie.Frame.Search.Recipes = CreateFrame("Frame", nil, Craftie.Frame.ScrollParentRecipes, "BackdropTemplate")
Craftie.Frame.Search.Recipes:SetWidth(Craftie.Frame.ScrollRecipes_Width-24)
...
Craftie.Frame.Button.SearchRecipes = CreateFrame("Button", nil, Craftie.Frame.Search.Recipes, "BackdropTemplate")
Craftie.Frame.Button.SearchRecipes:SetSize(24, 23)
Craftie.Frame.Button.SearchRecipes:SetPoint("TOPLEFT", Craftie.Frame.Search.Recipes:GetWidth()-24, -1)
Craftie.Frame.Button.SearchRecipesIcon = Craftie.Frame.Button.SearchRecipes:CreateTexture(nil, "ARTWORK")
Craftie.Frame.Button.SearchRecipesIcon:SetSize(18, 18)
Craftie.Frame.Button.SearchRecipesIcon:SetPoint("CENTER", 0, 0)
Craftie.Frame.Button.SearchRecipesIcon:SetTexture(Craftie._G.Path ..  "Images/UI-Craftie-Button-Search-Clear.png")
...
for i=1, Craftie.MAX_REAGENTS do
  ...
  Craftie.Frame.Reagent.QuanI[i]:SetFont(Craftie._G.Font.Style, 10, "OUTLINE | SLUG")
  ...
  Craftie.Frame.Reagent.QuanR[i]:SetFont(Craftie._G.Font.Style, 10, "OUTLINE | SLUG")
