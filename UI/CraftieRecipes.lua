...
Craftie.Frame.Button.SearchRecipesIcon:SetTexture(Craftie._G.Path ..  "Images/UI-btn_searchclear.png")
...
Craftie.Frame.Craft.Back:SetTexture(Craftie._G.Path .. "Images/UI-Craftie-CraftToast.png")
