...
Craftie.Frame.Button.Minimap:SetSize(30, 30)
...
Craftie.Frame.Button.Minimap.BorderBG:SetTexture(Craftie._G.Path .. "Images/" .. Craftie._G.Icon)
Craftie.Frame.Button.Minimap.BorderGlow = Craftie.Frame.Button.Minimap:CreateTexture(nil, "ARTWORK")
Craftie.Frame.Button.Minimap.BorderGlow:SetSize(Craftie.Frame.Button.Minimap:GetWidth()-4, Craftie.Frame.Button.Minimap:GetHeight()-4)
Craftie.Frame.Button.Minimap.BorderGlow:SetPoint("CENTER", 0, 0)
Craftie.Frame.Button.Minimap.BorderGlow:SetTexture(Craftie._G.Path .. "Images/icon_default_simple_glow.png")
Craftie.Frame.Button.Minimap.BorderGlow:SetAlpha(0.6)
Craftie.Frame.Button.Minimap.BorderGlow:Hide()
...
Craftie.Frame.Button.Minimap:SetScript("OnEnter", function(self)
  ...
  GameTooltip:Show()
	Craftie.Frame.Button.Minimap.BorderGlow:Show()
end)
