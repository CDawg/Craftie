...
Craftie.Frame.Button.Minimap:SetScript("OnEnter", function(self)
  ...
  GameTooltip:AddLine(" ")
  GameTooltip:AddDoubleLine(Craftie.Tooltip.Blue .. "Left Click", "|CFFFFFFFFOpen Craftie")
  GameTooltip:AddDoubleLine(Craftie.Tooltip.Blue .. "Right Click", "|CFFFFFFFFCraftie Options")
  GameTooltip:Show()
