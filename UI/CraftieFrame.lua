...
Craftie.Frame.Back = Craftie.Frame:CreateTexture(nil, "BACKGROUND", nil, 1)
--Craftie.Frame.Back:SetAllPoints()
Craftie.Frame.Back:SetPoint("TOPLEFT", 0, -20)
Craftie.Frame.Back:SetWidth(Craftie.Frame:GetWidth()-4)
Craftie.Frame.Back:SetHeight(Craftie.Frame:GetHeight()-24)
Craftie.Frame.Back:SetTexture(Craftie._G.Image.Background.Light)
Craftie.Frame.Back:SetVertexColor(1, 0.94, 0.86)

Craftie.Frame.BotShadow = Craftie.Frame:CreateTexture(nil, "BACKGROUND", nil, 2)
...
Craftie.Frame.HeaderBack = Craftie.Frame:CreateTexture(nil, "BACKGROUND", nil, 1)
Craftie.Frame.HeaderBack:SetPoint("TOPLEFT", 0, 0)
Craftie.Frame.HeaderBack:SetWidth(Craftie.Frame:GetWidth()-4)
Craftie.Frame.HeaderBack:SetHeight(20)
Craftie.Frame.HeaderBack:SetTexture(Craftie._G.Path .. "Images/Backgrounds/UI-Craftie-Header.png")
Craftie.Frame.HeaderBack:SetVertexColor(1, 0.94, 0.86)
...
Craftie.Frame.CrafterProgBar.Spark:SetSize(16, 24)
Craftie.Frame.CrafterProgBar.Spark:Hide()
...
Craftie.Frame.TabSide[Craftie.TabTop].Select:SetSize(Craftie.Frame.TabSide[Craftie.TabTop]:GetWidth()-8, Craftie.Frame.TabSide[Craftie.TabTop]:GetHeight()-8)
Craftie.Frame.TabSide[Craftie.TabTop].Select:SetPoint("CENTER", 3, -1)
Craftie.Frame.TabSide[Craftie.TabTop].Select:SetTexture("Interface/ContainerFrame/UI-Icon-QuestBorder")
Craftie.Frame.TabSide[Craftie.TabTop].Select:SetDrawLayer(tabbar_frame.layer, tabbar_frame.level)
Craftie.Frame.TabSide[Craftie.TabTop].Select:SetAlpha(0.8)
Craftie.Frame.TabSide[Craftie.TabTop].Select:Hide()
Craftie.Frame.TabSide[Craftie.TabTop].Border = Craftie.Frame.TabSide[Craftie.TabTop]:CreateTexture(nil, "BORDER")
Craftie.Frame.TabSide[Craftie.TabTop].Border:SetSize(3, Craftie.Frame.TabSide[Craftie.TabTop]:GetHeight()-2)
Craftie.Frame.TabSide[Craftie.TabTop].Border:SetPoint("CENTER", 20, -1)
Craftie.Frame.TabSide[Craftie.TabTop].Border:SetTexture(Craftie._G.Image.Background.Light)
Craftie.Frame.TabSide[Craftie.TabTop].Border:SetDrawLayer("BORDER", 1)
Craftie.Frame.TabSide[Craftie.TabTop].Border:Hide()
Craftie.Frame.TabSide[Craftie.TabTop].Glow = Craftie.Frame.TabSide[Craftie.TabTop]:CreateTexture(nil, tabbar_frame.layer)
Craftie.Frame.TabSide[Craftie.TabTop].Glow:SetSize(Craftie.Frame.TabSide[Craftie.TabTop]:GetWidth()-4, Craftie.Frame.TabSide[Craftie.TabTop]:GetHeight()-4)
Craftie.Frame.TabSide[Craftie.TabTop].Glow:SetPoint("CENTER", 3, -1)
Craftie.Frame.TabSide[Craftie.TabTop].Glow:SetTexture("Interface/ContainerFrame/UI-Icon-QuestBorder")
Craftie.Frame.TabSide[Craftie.TabTop].Glow:SetDrawLayer(tabbar_frame.layer, tabbar_frame.level)
Craftie.Frame.TabSide[Craftie.TabTop].Glow:Hide()
Craftie.Frame.TabSide[Craftie.TabTop].Tip = Craftie.Frame.TabSide[Craftie.TabTop]:CreateTexture(nil, tabbar_frame.layer)
Craftie.Frame.TabSide[Craftie.TabTop].Tip:SetSize(Craftie.Frame.TabSide[Craftie.TabTop]:GetWidth()-10, Craftie.Frame.TabSide[Craftie.TabTop]:GetHeight()+8)
Craftie.Frame.TabSide[Craftie.TabTop].Tip:SetPoint("CENTER", -20, 0)
Craftie.Frame.TabSide[Craftie.TabTop].Tip:SetTexture(Craftie._G.Image.Button.Arrow)
Craftie.Frame.TabSide[Craftie.TabTop].Tip:SetDrawLayer(tabbar_frame.layer, tabbar_frame.level)
Craftie.Frame.TabSide[Craftie.TabTop].Tip:Hide()
Craftie.Frame.TabSide[Craftie.TabTop].Hover = Craftie.Frame.TabSide[Craftie.TabTop]:CreateTexture(nil, tabbar_frame.layer)
Craftie.Frame.TabSide[Craftie.TabTop].Hover:SetSize(Craftie.Frame.TabSide[Craftie.TabTop]:GetWidth()-9, Craftie.Frame.TabSide[Craftie.TabTop]:GetHeight()-9)
Craftie.Frame.TabSide[Craftie.TabTop].Hover:SetPoint("TOPLEFT", 7, -5)
Craftie.Frame.TabSide[Craftie.TabTop].Hover:SetTexture("Interface/Buttons/ButtonHilight-Square")
Craftie.Frame.TabSide[Craftie.TabTop].Hover:SetBlendMode("ADD")
Craftie.Frame.TabSide[Craftie.TabTop].Hover:SetDrawLayer("OVERLAY", tabbar_frame.level)
Craftie.Frame.TabSide[Craftie.TabTop].Hover:Hide()
Craftie.Frame.TabSide[Craftie.TabTop]:SetScript("OnEnter", function(self)
  CraftieTooltip:ClearLines()
  CraftieTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT", 20)
  CraftieTooltip:AddLine(Craftie.Color.Silver .. "News & Updates")
  CraftieTooltip:Show()
  self.Hover:Show()
end)
Craftie.Frame.TabSide[Craftie.TabTop]:SetScript("OnLeave", function(self)
  self.Hover:Hide()
  CraftieTooltip:Hide()
end)
Craftie.Frame.TabSide[Craftie.TabTop]:SetScript("OnClick", function(self)
  Craftie:TabSelectSide(Craftie.TabTop, true)
end)
...
for i,v in pairs(Craftie.Professions) do
  ...
  Craftie.Frame.TabSide[i].Border:SetSize(3, Craftie.Frame.TabSide[i]:GetHeight()-2)
  Craftie.Frame.TabSide[i].Border:SetPoint("CENTER", 20, -1)
  Craftie.Frame.TabSide[i].Border:SetTexture(Craftie._G.Image.Background.Light)
  Craftie.Frame.TabSide[i].Border:SetDrawLayer("BORDER", 1)
  ...
  Craftie.Frame.TabSide[i].Tip:SetSize(Craftie.Frame.TabSide[i]:GetWidth()-10, Craftie.Frame.TabSide[i]:GetHeight()+8)
  Craftie.Frame.TabSide[i].Tip:SetPoint("CENTER", -20, 0)
...
Craftie.Frame.Button.Minimap.IconHighlight = Craftie.Frame.Button.Minimap:CreateTexture(nil, "BORDER")
Craftie.Frame.Button.Minimap.IconHighlight:SetSize(Craftie.Frame.Button.Minimap:GetWidth()+10, Craftie.Frame.Button.Minimap:GetHeight()+10)
Craftie.Frame.Button.Minimap.IconHighlight:SetPoint("CENTER", 0, 0)
Craftie.Frame.Button.Minimap.IconHighlight:SetTexture("Interface/UNITPOWERBARALT/PandarenTraining_Circular_Flash")
Craftie.Frame.Button.Minimap.IconHighlight:SetBlendMode("ADD")
