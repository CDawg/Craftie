...
Craftie.Frame.Scroll.Parent.Players.Back:SetTexture(Craftie._G.Path .. "images/stationary_players")
]==]--
...
Craftie.Frame.Search.Player.Text:SetFont(Craftie._G.Font.Style, 11, "OUTLINE")
...
for i=1, Craftie.MAX_PLAYERS do
  ...
  Craftie.Frame.Scroll.Players.List.Text[i]:SetFont(Craftie._G.Font.Style, Craftie._G.Font.Size, "SLUG")
...
Craftie.Frame.Scroll.Recipes.Results:SetFont(Craftie._G.Font.Style, Craftie._G.Font.Size, "SLUG")
...
Craftie.Frame.Scroll.Recipes.Empty:SetFont(Craftie._G.Font.Style, Craftie._G.Font.Size, "SLUG")
...
for i=1, Craftie.MAX_RECIPES do
  ...
  Craftie.Frame.Scroll.Recipes.List.Text[i]:SetFont(Craftie._G.Font.Style, Craftie._G.Font.Size, "SLUG")
