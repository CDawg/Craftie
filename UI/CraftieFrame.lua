...
Craftie.Frame.ItemerLevel = CreateFrame("Frame", "Craftie.Frame.ItemerLevel", Craftie.Frame, "BackdropTemplate")
Craftie.Frame.ItemerLevel:SetWidth(250)
Craftie.Frame.ItemerLevel:SetHeight(20)
Craftie.Frame.ItemerLevel:SetPoint("TOPLEFT", 400, -30)
Craftie.Frame.ItemerLevel:SetBackdrop(Craftie.Backdrop.General)
Craftie.Frame.ItemerLevel:SetBackdropColor(0, 1, 0, 0)
Craftie.Frame.ItemerLevel:SetBackdropBorderColor(1, 1, 1, 0)
--Craftie.Frame.ItemerLevel:Hide() --this bugs out the mask on the prog bar. Draw first then hide later

Craftie.Frame.ItemerProgBar = Craftie.Frame.ItemerLevel:CreateTexture(nil, "ARTWORK")
Craftie.Frame.ItemerProgBar:SetSize(246, 15)
Craftie.Frame.ItemerProgBar:SetPoint("TOPLEFT", 0, -5)
Craftie.Frame.ItemerProgBar:SetTexture("Interface/Buttons/GREENGRAD64")
Craftie.Frame.ItemerProgBar:SetMask(Craftie._G.Path .. "Images/ProgBarMask.png")
Craftie.Frame.ItemerProgBarS = Craftie.Frame.ItemerLevel:CreateTexture(nil, "OVERLAY")
Craftie.Frame.ItemerProgBarS:SetSize(80, 80)
Craftie.Frame.ItemerProgBarS:SetPoint("TOPLEFT", 5, 10)
Craftie.Frame.ItemerProgBarS:SetTexture("Interface/COMMON/StreamSpark")
Craftie.Frame.ItemerProgBorder = Craftie.Frame.ItemerLevel:CreateTexture(nil, "OVERLAY")
Craftie.Frame.ItemerProgBorder:SetSize(250, 34)
Craftie.Frame.ItemerProgBorder:SetPoint("TOPLEFT", 0, 5)
Craftie.Frame.ItemerProgBorder:SetTexture("Interface/PaperDollInfoFrame/UI-Character-Skills-BarBorder")

Craftie.Frame.ItemerProgLevel = Craftie.Frame.ItemerLevel:CreateFontString(nil, "ARTWORK")
Craftie.Frame.ItemerProgLevel:SetFont(Craftie._G.Font.Style, Craftie._G.Font.Size, "OUTLINE | SLUG")
Craftie.Frame.ItemerProgLevel:SetPoint("CENTER", 4, -2)
Craftie.Frame.ItemerProgLevel:SetJustifyH("LEFT")
Craftie.Frame.ItemerProgLevel:SetText("")
...
Craftie.Frame.Button.Options:SetScript("OnEnter", function(self)
  CraftieTooltip:ClearLines()
  CraftieTooltip:SetOwner(self, "ANCHOR_RIGHT")
  CraftieTooltip:AddLine("|CFFDEDEDESettings")
  CraftieTooltip:Show()
end)
...
Craftie.Frame.Button.Minimap:SetScript("OnEnter", function(self)
  ...
  GameTooltip:AddLine(" ")
  GameTooltip:AddDoubleLine(Craftie.Tooltip.Color[1] .. "Left Click", "|CFFFFFFFFOpen Craftie")
  GameTooltip:AddDoubleLine(Craftie.Tooltip.Color[1] .. "Right Click", "|CFFFFFFFFCraftie Options")
  GameTooltip:Show()
