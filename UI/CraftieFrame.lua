...
for i,v in pairs(Craftie.Professions) do
  ...
  Craftie.Frame.TabSide[i].Select = Craftie.Frame.TabSide[i]:CreateTexture(nil, "ARTWORK")
  ...
  Craftie.Frame.TabSide[i].Select:SetDrawLayer("ARTWORK", 6)
  ...
  Craftie.Frame.TabSide[i].Glow:SetDrawLayer("ARTWORK", 7)
  Craftie.Frame.TabSide[i].Glow:Hide()
  Craftie.Frame.TabSide[i].Tip = Craftie.Frame.TabSide[i]:CreateTexture(nil, "ARTWORK")
  ...
  Craftie.Frame.TabSide[i].Tip:SetDrawLayer("ARTWORK", 7)
