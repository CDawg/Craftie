...
Craftie.CreditScrollFrame:SetBackdropColor(0, 0, 0, 0)
Craftie.CreditScrollFrame:SetBackdropBorderColor(1, 1, 1, 0)
Craftie.CreditScrollFrameBack = Craftie.CreditScrollFrame:CreateTexture(nil, "BACKGROUND")
Craftie.CreditScrollFrameBack:SetWidth(Craftie.CreditScrollFrame:GetWidth()-8)
Craftie.CreditScrollFrameBack:SetHeight(Craftie.CreditScrollFrame:GetHeight())
Craftie.CreditScrollFrameBack:SetPoint("TOPLEFT", -15, 0)
Craftie.CreditScrollFrameBack:SetTexture("Interface/ACHIEVEMENTFRAME/UI-Achievement-StatsBackground")
--Craftie.CreditScrollFrameBack:SetAlpha(0.3)
