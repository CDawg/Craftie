...
Craftie.ScrollFrameUpdates:SetWidth(Craftie.Updates_w+10)
Craftie.ScrollFrameUpdates:SetHeight(Craftie.Updates_h-40)
Craftie.ScrollFrameUpdates:SetPoint("TOPLEFT", 0, 10)
--Craftie.ScrollFrameUpdates:SetBackdrop(Craftie.Backdrop.General)
--Craftie.ScrollFrameUpdates:SetBackdropColor(0, 0, 0, 0.3)
--Craftie.ScrollFrameUpdates:SetBackdropBorderColor(1, 1, 1, 0.1)
Craftie.ScrollFrameUpdates.Child = CreateFrame("ScrollFrame", nil, Craftie.ScrollFrameUpdates, "UIPanelScrollFrameTemplate")
Craftie.ScrollFrameUpdates.Child:SetPoint("TOPLEFT", Craftie.ScrollFrameUpdates, "TOPLEFT", 5, -28)
...
Craftie.ScrollFrameUpdatesChildFrame:SetSize(Craftie.Updates_w-40, Craftie.Updates_h)
...
Craftie.ScrollFrameUpdates.Child.ScrollBar:SetPoint("BOTTOMRIGHT", Craftie.ScrollFrameUpdates.Child, "BOTTOMRIGHT", -42, 15)
...
Craftie.ScrollFrameCredits:SetWidth(Craftie.Credit_w+10)
Craftie.ScrollFrameCredits:SetHeight(Craftie.Credit_h-40)
Craftie.ScrollFrameCredits:SetPoint("TOPLEFT", 0, 10)
Craftie.ScrollFrameCredits:SetBackdrop(Craftie.Backdrop.General)
Craftie.ScrollFrameCredits:SetBackdropColor(0, 0, 0, 0)
Craftie.ScrollFrameCredits:SetBackdropBorderColor(1, 1, 1, 0)
--[==[
Craftie.ScrollFrameCreditsBack = Craftie.ScrollFrameCredits:CreateTexture(nil, "BACKGROUND")
Craftie.ScrollFrameCreditsBack:SetWidth(Craftie.ScrollFrameCredits:GetWidth()-8)
Craftie.ScrollFrameCreditsBack:SetHeight(Craftie.ScrollFrameCredits:GetHeight())
Craftie.ScrollFrameCreditsBack:SetPoint("TOPLEFT", -15, 0)
Craftie.ScrollFrameCreditsBack:SetTexture("Interface/ACHIEVEMENTFRAME/UI-Achievement-StatsBackground")
--Craftie.ScrollFrameCreditsBack:SetAlpha(0.3)
]==]--

Craftie.ScrollFrameCredits.Child = CreateFrame("ScrollFrame", nil, Craftie.ScrollFrameCredits, "UIPanelScrollFrameTemplate")
Craftie.ScrollFrameCredits.Child:SetPoint("TOPLEFT", Craftie.ScrollFrameCredits, "TOPLEFT", 5, -28)
...
Craftie.ScrollFrameCreditsChildFrame:SetSize(Craftie.Credit_w-40, Craftie.Credit_h)
...
Craftie.ScrollFrameCredits.Child.ScrollBar:SetPoint("BOTTOMRIGHT", Craftie.ScrollFrameCredits.Child, "BOTTOMRIGHT", -42, 15)
