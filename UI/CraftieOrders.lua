...
Craftie.Frame.ScrollOrderList.Child:SetPoint("TOPLEFT", Craftie.Frame.ScrollOrderList, "TOPLEFT", 4, -10)
Craftie.Frame.ScrollOrderList.Child:SetPoint("BOTTOMRIGHT", Craftie.Frame.ScrollOrderList, "BOTTOMRIGHT", 8, 10)
...
Craftie.Frame.ScrollOrderList.Child.ScrollBar:SetPoint("TOPLEFT", Craftie.Frame.ScrollOrderList.Child, "TOPRIGHT", -33, -5)
Craftie.Frame.ScrollOrderList.Child.ScrollBar:SetPoint("BOTTOMRIGHT", Craftie.Frame.ScrollOrderList.Child, "BOTTOMRIGHT", -10, 5)
...
for k,v in pairs(columns) do
  ...
  Craftie.Frame.ScrollOrderListCol[k].Text:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, Craftie._G.Font.Flags)
  Craftie.Frame.ScrollOrderListCol[k].Text:SetPoint("TOPLEFT", 8, -6)
  Craftie.Frame.ScrollOrderListCol[k].Text:SetText(v[1])
end

function Craftie:BuildRowOrder(i)
  ...
  Craftie.Frame.ScrollOrderListRow[i]:SetWidth(Craftie.Frame.CraftOrders:GetWidth()-30)
  ...
  Craftie.Frame.ScrollOrderListName[i]:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, Craftie._G.Font.Flags)
  ...
  Craftie.Frame.ScrollOrderListItem[i]:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, Craftie._G.Font.Flags)
  ...
  Craftie.Frame.ScrollOrderListCount[i]:SetFont(Craftie._G.Font.Style.Numeric, Craftie._G.Font.Size+2, Craftie._G.Font.Flags)
  ...
  Craftie.Frame.ScrollOrderListDate[i]:SetFont(Craftie._G.Font.Style.Numeric, Craftie._G.Font.Size, Craftie._G.Font.Flags)
