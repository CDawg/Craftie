...
--Craftie.Frame.ScrollPlayers.ResultsFrame:SetBackdrop(Craftie.Backdrop.Borderless)
--Craftie.Frame.ScrollPlayers.ResultsFrame:SetBackdropColor(0.2, 0.6, 1, 0.5)
