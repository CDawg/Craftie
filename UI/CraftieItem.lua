...
Craftie.Frame.Item.Text:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size+1, Craftie._G.Font.Flags)
...
Craftie.Frame.Item.HLink:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size+9, Craftie._G.Font.Flags)
...
for i=1, Craftie.MAX_REAGENTS do
  ...
  Craftie.Frame.Reagent.Text[i]:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, Craftie._G.Font.Flags)
  ...
  Craftie.Frame.Reagent.Data[i]:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size-1, Craftie._G.Font.Flags)
  ...
  Craftie.Frame.Reagent.Quan[i]:SetFont(Craftie._G.Font.Style.Numeric, Craftie._G.Font.Size+2, "OUTLINE")
...
Craftie.Frame.Item.SkillText:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, Craftie._G.Font.Flags)
...
Craftie.Frame.Item.SourceTitle:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, Craftie._G.Font.Flags)
...
Craftie.Frame.Item.SourceText:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, Craftie._G.Font.Flags)
...
Craftie.Frame.ItemButtonRequest:SetScript("OnClick", function(self)
  if (Craftie.Req_Lock == 1) then
    Craftie:Notification("Please wait " .. Craftie.REQUEST_TIMER .. " seconds before sending another request.", Craftie.CHAT.WARN)
  else
    Craftie.Req_Lock = 1
    ...
    Craftie:PacketSend(Craftie.Packet.Prefix.Order, Craftie.Player.Name .. "," .. Craftie.Player.ClassID .. "," .. link .. "," .. count .. "," .. Craftie.Date, "WHISPER", Craftie.Selected_Name)
    --C_Timer.After(2, function()
    --end)
    Craftie.Frame.Item.ReqMessage:SetText("Request sent to " .. Craftie.Selected_Name .. " for|n" .. link .. "x" .. count)
...
Craftie.Frame.Item.ReqMessage:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, Craftie._G.Font.Flags)
