...
Craftie.Logger.Title:SetPoint("TOPLEFT", 4, -4)
...
Craftie.Logger.ScrollFrame:SetHeight(Craftie.Logger_h-60)
Craftie.Logger.ScrollFrame:SetPoint("TOPLEFT", 0, -40)
...
Craftie.Logger.ScrollFrame.Child:SetPoint("TOPLEFT", Craftie.Logger.ScrollFrame, "TOPLEFT", 3, -3)
...
Craftie.Logger.ScrollFrame.Child.ScrollBar:SetPoint("TOPLEFT", Craftie.Logger.ScrollFrame.Child, "TOPRIGHT", 0, -17)
