...
Craftie.Options.CellCraftersTitle:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size+2, "SLUG")
...
Craftie.Options.CheckboxLibrary.Text:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, "SLUG")
...
Craftie.Options.CheckboxGuild.Text:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, "SLUG")
...
Craftie.Options.CellNotificationsTitle:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size+2, "SLUG")
...
for i,v in pairs(Craftie._L.Options.Notifications) do
  if ((type(i) == "number") and (i <= 3)) then
    ...
    Craftie.Options.CheckboxNotif[i].Text:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, "SLUG")
...
Craftie.Options.CellRecipesTitle:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size+2, "SLUG")
...
Craftie.Options.CheckboxCrafterThreshold.Text:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, "SLUG")
...
Craftie.Options.CheckboxCrafterOpen.Text:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size, "SLUG")
...
Craftie.Options.CellFrameTitle:SetFont(Craftie._G.Font.Style.Alpha, Craftie._G.Font.Size+2, "SLUG")
