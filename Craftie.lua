...
for i,v in pairs(Craftie.Professions) do
  ...
  Craftie.TabSide.Frame[i]:SetPoint("TOPLEFT", -40, (-i*40)-28)
  ...
  Craftie.TabSide.Frame[i].Shadow:SetBackdropColor(0, 0, 0, 0.4)
  ...
  Craftie.TabSide.Frame[i].Glow:SetSize(Craftie.TabSide.Frame[i]:GetWidth()-9, Craftie.TabSide.Frame[i]:GetHeight()-9)
  Craftie.TabSide.Frame[i].Glow:SetPoint("TOPLEFT", 7, -5)
  Craftie.TabSide.Frame[i].Glow:SetTexture("Interface/Buttons/CheckButtonHilight")
  Craftie.TabSide.Frame[i].Glow:SetBlendMode("ADD")
  Craftie.TabSide.Frame[i].Glow:SetDrawLayer("ARTWORK", 6)
  Craftie.TabSide.Frame[i].Glow:Hide()
  Craftie.TabSide.Frame[i].Select = Craftie.TabSide.Frame[i]:CreateTexture(nil, "ARTWORK")
  Craftie.TabSide.Frame[i].Select:SetSize(Craftie.TabSide.Frame[i]:GetWidth()-9, Craftie.TabSide.Frame[i]:GetHeight()-9)
  Craftie.TabSide.Frame[i].Select:SetPoint("TOPLEFT", 7, -5)
  Craftie.TabSide.Frame[i].Select:SetTexture("Interface/Buttons/ButtonHilight-Square")
  Craftie.TabSide.Frame[i].Select:SetBlendMode("ADD")
  Craftie.TabSide.Frame[i].Select:SetDrawLayer("ARTWORK", 7)
  Craftie.TabSide.Frame[i].Select:Hide()

  Craftie.TabSide.Frame[i]:SetScript("OnEnter", function(self)
    Craftie.TabSide.Frame[i].Select:Show()
