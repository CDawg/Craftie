...
Craftie.Frame.BotShadow:SetTexture(Craftie._G.dir .. "images/ShadowOverlay-Bottom.png", "REPEAT")
...
Craftie.Frame.Icon:SetTexture(Craftie._G.dir .. "images/icon_default.tga")
--Craftie.Frame.Icon:SetTexture(Craftie._G.dir .. "images/Trade_Engraving")

Craftie.Frame.Title = Craftie.Frame:CreateFontString(nil, "ARTWORK")
Craftie.Frame.Title:SetFont(Craftie._G.font, 12, "SLUG")
...
Craftie.Frame.Title.Sub:SetFont(Craftie._G.font, 14, "SLUG")
...
Craftie.Frame.Title.Prof:SetFont(Craftie._G.font, 14, "SLUG")
...
for i=1, Craftie.MAX_PLAYERS do
  ...
  Craftie.Frame.Scroll.Players.List.Text[i]:SetFont(Craftie._G.font, Craftie._G.fontSize, "SLUG")
...
Craftie.Frame.Scroll.Recipes.Results:SetFont(Craftie._G.font, Craftie._G.fontSize, "SLUG")
...
Craftie.Frame.Scroll.Recipes.Empty:SetFont(Craftie._G.font, Craftie._G.fontSize, "SLUG")
...
Craftie.Frame.Craft.Text:SetFont(Craftie._G.font, 12, "SLUG")
...
Craftie.Frame.Craft.HLink:SetFont(Craftie._G.font, 20, "SLUG")
...
Craftie.Frame.Craft.ID:SetFont(Craftie._G.font, Craftie._G.fontSize, "SLUG")
...
Craftie.Frame.Craft.Skill:SetFont(Craftie._G.font, Craftie._G.fontSize, "SLUG")
...
Craftie.Frame.Craft.SourceTitle:SetFont(Craftie._G.font, Craftie._G.fontSize, "SLUG")
...
Craftie.Frame.Craft.Source:SetFont(Craftie._G.font, Craftie._G.fontSize, "SLUG")
...
for i=1, Craftie.MAX_REAGENTS do
  ...
  Craftie.Frame.Reagent.Text[i]:SetFont(Craftie._G.font, 10, "SLUG")
  ...
  Craftie.Frame.Reagent.Data[i]:SetFont(Craftie._G.font, 10, "SLUG")
  ...
  Craftie.Frame.Reagent.QuanI[i]:SetFont(Craftie._G.font, 11, "SLUG")
  ...
  Craftie.Frame.Reagent.Dash[i]:SetFont(Craftie._G.font, 12, "SLUG")
  ...
  Craftie.Frame.Reagent.QuanR[i]:SetFont(Craftie._G.font, 11, "SLUG")
...
for i=1, Craftie.MAX_RECIPES do
  ...
  Craftie.Frame.Scroll.Recipes.List.Text[i]:SetFont(Craftie._G.font, Craftie._G.fontSize, "SLUG")
...
Craftie.Frame.Button.Minimap.BorderBG:SetTexture(Craftie._G.dir .. "images/icon_default.tga")
