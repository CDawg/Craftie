...
for i,v in pairs(Craftie.Professions) do
  ...
  Craftie.TabSide.Frame[i].Glow:SetSize(Craftie.TabSide.Frame[i]:GetWidth()+2, Craftie.TabSide.Frame[i]:GetHeight()+2)
  Craftie.TabSide.Frame[i].Glow:SetPoint("CENTER", 2, 0)
  Craftie.TabSide.Frame[i].Glow:SetTexture("Interface/SPELLBOOK/RotationIconFrame")
  ...
  Craftie.TabSide.Frame[i].BorderSelect:SetSize(Craftie.TabSide.Frame[i]:GetWidth(), Craftie.TabSide.Frame[i]:GetHeight()+18)
  Craftie.TabSide.Frame[i].BorderSelect:SetPoint("TOPLEFT", 5, -5)
  Craftie.TabSide.Frame[i].BorderSelect:SetTexture("Interface/PaperDollInfoframe/UI-Character-StatBackground")
